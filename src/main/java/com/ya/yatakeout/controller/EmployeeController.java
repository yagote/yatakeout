...
public class EmployeeController {
    @Autowired
    private EmployeeService employeeService;    //把接口注入进来
     ...
     */
    @PostMapping("/login")
    public R<Employee> login(HttpServletRequest request, @RequestBody Employee employee){   //@RequestBody将员工信息结果封装为JSON对象
        ...
        Employee emp = employeeService.getOne(queryWrapper);    //每个用户名时唯一的，所以使用getOne
